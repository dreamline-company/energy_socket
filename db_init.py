...
cursor = cnx.cursor()
main_var = ["id INT AUTO_INCREMENT PRIMARY KEY", "object_number VARCHAR(8)", "timestamp_ctr datetime", "temperature int", "voltage int", "temperature_cpu int", "restart_number int", "cell_number VARCHAR(8)"]
...
create_table = "CREATE TABLE dreamline_regular_data ( " + ','.join(regular_table_columns + ["timestamp datetime"]) + ");"
print(create_table)
# Insert new employee
